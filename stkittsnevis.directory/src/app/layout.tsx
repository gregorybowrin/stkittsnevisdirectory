...
:root {
  /* Color Palette - Caribbean Modernism */
  --primary: #ff6b00;
...
/* Footer */
.footer { background: #1a1a1a; color: white; padding: 8rem 0 4rem; }
.footer-grid { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; gap: 4rem; }
.footer-brand h2 { font-family: var(--font-display); font-size: 2rem; font-weight: 800; margin-bottom: 1.5rem; }
.footer-brand p { color: #aaa; max-width: 300px; line-height: 1.6; }
.footer-links h4 { font-size: 1.1rem; font-weight: 700; margin-bottom: 2rem; }
.footer-links ul { list-style: none; }
.footer-links li { margin-bottom: 1rem; }
.footer-links a { color: #aaa; text-decoration: none; transition: color 0.2s; }
.footer-links a:hover { color: var(--secondary); }
.footer-bottom { border-top: 1px solid #333; margin-top: 6rem; padding-top: 3rem; display: flex; justify-content: space-between; align-items: center; color: #666; font-size: 0.9rem; }
  ...
  .hero-visual { height: 400px; margin-top: 2rem; }
      ...
      <body>
        ...
        <div style={{ position: 'fixed', bottom: '10px', right: '10px', background: '#ff6b00', color: 'white', padding: '5px 10px', borderRadius: '5px', fontSize: '10px', zIndex: 10000, fontWeight: 'bold' }}>
          SKN v6.0 - EMBEDDED STYLES (FINAL)
        </div>
      </body>
    </html>
  );
