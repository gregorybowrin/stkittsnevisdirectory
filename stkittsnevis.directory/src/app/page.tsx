        ...
        <div className="container hero-content">
          <div className="hero-text">
            ...
            <div className="search-box-vibrant">
              ...
              <button className="search-btn btn-primary" style={{ borderRadius: '100px' }}>Search Now</button>
            </div>
          </div>
          
          <div className="hero-visual">
             <div className="visual-card-main">
                <Image src="/hero-bg.png" alt="St. Kitts" fill priority unoptimized />
             </div>
             <div className="visual-card-sub">
                <Image src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&q=80&w=600" alt="Island Culture" fill unoptimized />
             </div>
